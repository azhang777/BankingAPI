...
public interface BillRepository extends JpaRepository<Bill, Long> {
 ...
 @Query(value = "SELECT w.* FROM bills  b JOIN account a ON b.account_id = a.account_id  WHERE a.account_id = ?1", nativeQuery = true)Set<Bill> findBillsByAccountId(Long accountId);
